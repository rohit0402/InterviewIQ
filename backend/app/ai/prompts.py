...
1. Resume Analysis
2. Resume vs Job Match Analysis
3. Complete Interview History

Each interview history item already contains:
- question
- candidate_answer
- evaluation_score
- evaluator_feedback

The evaluation score and evaluator feedback have already been generated by another AI system.

DO NOT modify or regenerate them.

Your task is to:

1. Evaluate the candidate's OVERALL interview performance.
2. Generate an ideal answer for every interview question.
3. Generate key learning points for every question.
4. Summarize the candidate's strengths.
5. Summarize the candidate's weaknesses.
6. Generate an improvement plan.
7. Provide a hiring recommendation.
